...
*/
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(d,h,y){d instanceof String&&(d=String(d));for(var v=d.length,A=0;A<v;A++){var S=d[A];if(h.call(y,S,A,d))return{i:A,v:S}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,h,y){d!=Array.prototype&&d!=Object.prototype&&(d[h]=y.value)};
$jscomp.getGlobal=function(d){return"undefined"!=typeof window&&window===d?d:"undefined"!=typeof global&&null!=global?global:d};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(d,h,y,v){if(h){y=$jscomp.global;d=d.split(".");for(v=0;v<d.length-1;v++){var A=d[v];A in y||(y[A]={});y=y[A]}d=d[d.length-1];v=y[d];h=h(v);h!=v&&null!=h&&$jscomp.defineProperty(y,d,{configurable:!0,writable:!0,value:h})}};
$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(d,y){return $jscomp.findInternal(this,d,y).v}},"es6","es3");
(function(d){d.fn.tableExport=function(h){function y(b){var c=[];A(b,"thead").each(function(){c.push.apply(c,A(d(this),a.theadSelector).toArray())});return c}function v(b){var c=[];A(b,"tbody").each(function(){c.push.apply(c,A(d(this),a.tbodySelector).toArray())});a.tfootSelector.length&&A(b,"tfoot").each(function(){c.push.apply(c,A(d(this),a.tfootSelector).toArray())});return c}function A(b,a){var c=b[0].tagName,p=b.parents(c).length;return b.find(a).filter(function(){return p===d(this).closest(c).parents(c).length})}
...
f+a.onCellHtmlHyperlink(t,c,e,b,k):"href"===a.htmlHyperlink?f+b:f+k;k=""}}})}if(k&&""!==k&&!0===a.htmlContent)f=d.trim(k);else if(k&&""!==k)if(""!==t.attr("data-tableexport-cellformat")){var l=k.replace(/\n/g,"\u2028").replace(/(<\s*br([^>]*)>)/gi,"\u2060"),n=d("<div/>").html(l).contents();b=!1;l="";d.each(n.text().split("\u2028"),function(b,c){0<b&&(l+=" ");!0!==a.preserve.leadingWS&&(c=ka(c));l+=!0!==a.preserve.trailingWS?la(c):c});d.each(l.split("\u2060"),function(b,c){0<b&&(f+="\n");!0!==a.preserve.leadingWS&&
(c=ka(c));!0!==a.preserve.trailingWS&&(c=la(c));f+=c.replace(/\u00AD/g,"")});f=f.replace(/\u00A0/g," ");if("json"===a.type||"excel"===a.type&&"xmlss"===a.mso.fileFormat||!1===a.numbers.output)b=ma(f),!1!==b&&(m="number",f=Number(b));else if(a.numbers.html.decimalMark!==a.numbers.output.decimalMark||a.numbers.html.thousandsSeparator!==a.numbers.output.thousandsSeparator)if(b=ma(f),!1!==b){n=(""+b.substr(0>b?1:0)).split(".");1===n.length&&(n[1]="");var r=3<n[0].length?n[0].length%3:0;m="number";f=(0>
b?"-":"")+(a.numbers.output.thousandsSeparator?(r?n[0].substr(0,r)+a.numbers.output.thousandsSeparator:"")+n[0].substr(r).replace(/(\d{3})(?=\d)/g,"$1"+a.numbers.output.thousandsSeparator):n[0])+(n[1].length?a.numbers.output.decimalMark+n[1]:"")}}else f=k;!0===a.escape&&(f=escape(f));"function"===typeof a.onCellData&&(f=a.onCellData(t,c,e,f,m))}void 0!==p&&(p.type=m);return f}function Aa(b){return 0<b.length&&!0===a.preventInjection&&0<="=+-@".indexOf(b.charAt(0))?"'"+b:b}function Na(b,a,e){return a+
"-"+e.toLowerCase()}function ea(b,a){(b=/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b))&&(a=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3])]);return a}function Ba(b){var a=L(b,"text-align"),e=L(b,"font-weight"),d=L(b,"font-style"),f="";"start"===a&&(a="rtl"===L(b,"direction")?"right":"left");700<=e&&(f="bold");"italic"===d&&(f+=d);""===f&&(f="normal");a={style:{align:a,bcolor:ea(L(b,"background-color"),[255,255,255]),color:ea(L(b,"color"),[0,0,0]),fstyle:f},colspan:O(b),rowspan:U(b)};null!==
...
typeof a.onAfterSaveToFile)a.onAfterSaveToFile(d,b)},100)}}}function K(a){var b,d="",p=0;if("string"===typeof a){a=a.replace(/\x0d\x0a/g,"\n");var f="";for(b=0;b<a.length;b++){var m=a.charCodeAt(b);128>m?f+=String.fromCharCode(m):(127<m&&2048>m?f+=String.fromCharCode(m>>6|192):(f+=String.fromCharCode(m>>12|224),f+=String.fromCharCode(m>>6&63|128)),f+=String.fromCharCode(m&63|128))}a=f}for(;p<a.length;){var t=a.charCodeAt(p++);f=a.charCodeAt(p++);b=a.charCodeAt(p++);m=t>>2;t=(t&3)<<4|f>>4;var k=(f&
...
(a.mso.worksheetName=a.worksheetName);a.mso.pageOrientation="l"===a.mso.pageOrientation.substr(0,1)?"landscape":"portrait";a.date.html=a.date.html||"";if(a.date.html.length){h=[];h.dd="(3[01]|[12][0-9]|0?[1-9])";h.mm="(1[012]|0?[1-9])";h.yyyy="((?:1[6-9]|2[0-2])\\d{2})";h.yy="(\\d{2})";var q=a.date.html.match(/[^a-zA-Z0-9]/)[0];q=a.date.html.toLowerCase().split(q);a.date.regex="^\\s*";a.date.regex+=h[q[0]];a.date.regex+="(.)";a.date.regex+=h[q[1]];a.date.regex+="\\2";a.date.regex+=h[q[2]];a.date.regex+=
"\\s*$";a.date.pattern=new RegExp(a.date.regex,"g");h=q.indexOf("dd")+1;a.date.match_d=h+(1<h?1:0);h=q.indexOf("mm")+1;a.date.match_m=h+(1<h?1:0);h=(0<=q.indexOf("yyyy")?q.indexOf("yyyy"):q.indexOf("yy"))+1;a.date.match_y=h+(1<h?1:0)}T=S(C);if("function"===typeof a.onTableExportBegin)a.onTableExportBegin();if("csv"===a.type||"tsv"===a.type||"txt"===a.type){var P="",Z=0;G=[];n=0;var pa=function(b,c,e){b.each(function(){r="";B(this,c,n,e+b.length,function(b,c,d){var e=r,f="";if(null!==b)if(b=E(b,c,
d),c=null===b||""===b?"":b.toString(),"tsv"===a.type)b instanceof Date&&b.toLocaleString(),f=W(c,"\t"," ");else if(b instanceof Date)f=a.csvEnclosure+b.toLocaleString()+a.csvEnclosure;else if(f=Aa(c),f=W(f,a.csvEnclosure,a.csvEnclosure+a.csvEnclosure),0<=f.indexOf(a.csvSeparator)||/[\r\n ]/g.test(f))f=a.csvEnclosure+f+a.csvEnclosure;r=e+(f+("tsv"===a.type?"\t":a.csvSeparator))});r=d.trim(r).substring(0,r.length-1);0<r.length&&(0<P.length&&(P+="\n"),P+=r);n++});return b.length};Z+=pa(d(C).find("thead").first().find(a.theadSelector),
"th,td",Z);A(d(C),"tbody").each(function(){Z+=pa(A(d(this),a.tbodySelector),"td,th",Z)});a.tfootSelector.length&&pa(d(C).find("tfoot").first().find(a.tfootSelector),"td,th",Z);P+="\n";if("string"===a.outputMode)return P;if("base64"===a.outputMode)return K(P);if("window"===a.outputMode){ja(!1,"data:text/"+("csv"===a.type?"csv":"plain")+";charset=utf-8,",P);return}M(P,a.fileName+"."+a.type,"text/"+("csv"===a.type?"csv":"plain"),"utf-8","","csv"===a.type&&a.csvUseBOM)}else if("sql"===a.type){n=0;G=[];
var D="INSERT INTO "+a.sql.tableEnclosure+a.tableName+a.sql.tableEnclosure+" (";u=y(d(C));d(u).each(function(){B(this,"th,td",n,u.length,function(b,c,d){b=E(b,c,d)||"";-1<b.indexOf(a.sql.columnEnclosure)&&(b=W(b.toString(),a.sql.columnEnclosure,a.sql.columnEnclosure+a.sql.columnEnclosure));D+=a.sql.columnEnclosure+b+a.sql.columnEnclosure+","});n++;D=d.trim(D).substring(0,D.length-1)});D+=") VALUES ";w=v(d(C));d(w).each(function(){r="";B(this,"td,th",n,u.length+w.length,function(a,c,d){a=E(a,c,d)||
"";-1<a.indexOf("'")&&(a=W(a.toString(),"'","''"));r+="'"+a+"',"});3<r.length&&(D+="("+r,D=d.trim(D).substring(0,D.length-1),D+="),");n++});D=d.trim(D).substring(0,D.length-1);D+=";";if("string"===a.outputMode)return D;if("base64"===a.outputMode)return K(D);M(D,a.fileName+".sql","application/sql","utf-8","",!1)}else if("json"===a.type){var X=[];G=[];u=y(d(C));d(u).each(function(){var a=[];B(this,"th,td",n,u.length,function(b,d,g){a.push(E(b,d,g))});X.push(a)});var qa=[];w=v(d(C));d(w).each(function(){var a=
{},c=0;B(this,"td,th",n,u.length+w.length,function(b,d,f){X.length?a[X[X.length-1][c]]=E(b,d,f):a[c]=E(b,d,f);c++});!1===d.isEmptyObject(a)&&qa.push(a);n++});h="head"===a.jsonScope?JSON.stringify(X):"data"===a.jsonScope?JSON.stringify(qa):JSON.stringify({header:X,data:qa});if("string"===a.outputMode)return h;if("base64"===a.outputMode)return K(h);M(h,a.fileName+".json","application/json","utf-8","base64",!1)}else if("xml"===a.type){n=0;G=[];var Q='<?xml version="1.0" encoding="utf-8"?>';Q+="<tabledata><fields>";
u=y(d(C));d(u).each(function(){B(this,"th,td",n,u.length,function(a,d,e){Q+="<field>"+E(a,d,e)+"</field>"});n++});Q+="</fields><data>";var Ea=1;w=v(d(C));d(w).each(function(){var a=1;r="";B(this,"td,th",n,u.length+w.length,function(b,d,g){r+="<column-"+a+">"+E(b,d,g)+"</column-"+a+">";a++});0<r.length&&"<column-1></column-1>"!==r&&(Q+='<row id="'+Ea+'">'+r+"</row>",Ea++);n++});Q+="</data></tabledata>";if("string"===a.outputMode)return Q;if("base64"===a.outputMode)return K(Q);M(Q,a.fileName+".xml",
"application/xml","utf-8","base64",!1)}else if("excel"===a.type&&"xmlss"===a.mso.fileFormat){var ra=[],F=[];d(C).filter(function(){return I(d(this))}).each(function(){function b(a,b,c){var f=[];d(a).each(function(){var b=0,e=0;r="";B(this,"td,th",n,c+a.length,function(a,c,m){if(null!==a){var k="";c=E(a,c,m);m="String";if(!1!==jQuery.isNumeric(c))m="Number";else{var g=Ma(c);!1!==g&&(c=g,m="Number",k+=' ss:StyleID="pct1"')}"Number"!==m&&(c=c.replace(/\n/g,"<br>"));g=O(a);a=U(a);d.each(f,function(){if(n>=
this.s.r&&n<=this.e.r&&e>=this.s.c&&e<=this.e.c)for(var a=0;a<=this.e.c-this.s.c;++a)e++,b++});if(a||g)a=a||1,g=g||1,f.push({s:{r:n,c:e},e:{r:n+a-1,c:e+g-1}});1<g&&(k+=' ss:MergeAcross="'+(g-1)+'"',e+=g-1);1<a&&(k+=' ss:MergeDown="'+(a-1)+'" ss:StyleID="rsp1"');0<b&&(k+=' ss:Index="'+(e+1)+'"',b=0);r+="<Cell"+k+'><Data ss:Type="'+m+'">'+d("<div />").text(c).html()+"</Data></Cell>\r";e++}});0<r.length&&(H+='<Row ss:AutoFitHeight="0">\r'+r+"</Row>\r");n++});return a.length}var c=d(this),e="";"string"===
typeof a.mso.worksheetName&&a.mso.worksheetName.length?e=a.mso.worksheetName+" "+(F.length+1):"undefined"!==typeof a.mso.worksheetName[F.length]&&(e=a.mso.worksheetName[F.length]);e.length||(e=c.find("caption").text()||"");e.length||(e="Table "+(F.length+1));e=d.trim(e.replace(/[\\\/[\]*:?'"]/g,"").substring(0,31));F.push(d("<div />").text(e).html());!1===a.exportHiddenCells&&(J=c.find("tr, th, td").filter(":hidden"),V=0<J.length);n=0;T=S(this);H="<Table>\r";e=b(y(c),"th,td",0);b(v(c),"td,th",e);
H+="</Table>\r";ra.push(H)});h={};q={};for(var l,R,Y=0,da=F.length;Y<da;Y++)l=F[Y],R=h[l],R=h[l]=null==R?1:R+1,2===R&&(F[q[l]]=F[q[l]].substring(0,29)+"-1"),1<h[l]?F[Y]=F[Y].substring(0,29)+"-"+h[l]:q[l]=Y;h='<?xml version="1.0" encoding="UTF-8"?>\r<?mso-application progid="Excel.Sheet"?>\r<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:o="urn:schemas-microsoft-com:office:office"\r xmlns:x="urn:schemas-microsoft-com:office:excel"\r xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet"\r xmlns:html="http://www.w3.org/TR/REC-html40">\r<DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">\r  <Created>'+
...
for(q=0;q<ra.length;q++)h+='<Worksheet ss:Name="'+F[q]+'" ss:RightToLeft="'+(a.mso.rtl?"1":"0")+'">\r'+ra[q],h=a.mso.rtl?h+'<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">\r<DisplayRightToLeft/>\r</WorksheetOptions>\r':h+'<WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel"/>\r',h+="</Worksheet>\r";h+="</Workbook>\r";if("string"===a.outputMode)return h;if("base64"===a.outputMode)return K(h);M(h,a.fileName+".xml","application/xml","utf-8","base64",!1)}else if("excel"===
a.type&&"xlsx"===a.mso.fileFormat){var aa=[],Fa=XLSX.utils.book_new();d(C).filter(function(){return I(d(this))}).each(function(){for(var b=d(this),c={},e=this.getElementsByTagName("tr"),g={s:{r:0,c:0},e:{r:0,c:0}},f=[],m,t=[],k=0,h=0,l,n,r,u,q,w=XLSX.SSF.get_table();k<e.length&&1E7>h;++k)if(l=e[k],n=!1,"function"===typeof a.onIgnoreRow&&(n=a.onIgnoreRow(d(l),k)),!0!==n&&(0===a.ignoreRow.length||-1===d.inArray(k,a.ignoreRow)&&-1===d.inArray(k-e.length,a.ignoreRow))&&!1!==I(d(l))){var y=l.children,
C=0;for(l=0;l<y.length;++l)q=y[l],u=+O(q)||1,C+=u;var A=0;for(l=n=0;l<y.length;++l)if(q=y[l],u=+O(q)||1,m=l+A,!sa(d(q),C,m+(m<n?n-m:0))){A+=u-1;for(m=0;m<f.length;++m){var v=f[m];v.s.c==n&&v.s.r<=h&&h<=v.e.r&&(n=v.e.c+1,m=-1)}(0<(r=+U(q))||1<u)&&f.push({s:{r:h,c:n},e:{r:h+(r||1)-1,c:n+u-1}});var D={type:""};m=E(q,k,l+A,D);v={t:"s",v:m};var B="";if(""!==d(q).attr("data-tableexport-cellformat")){var x=parseInt(d(q).attr("data-tableexport-xlsxformatid")||0);0===x&&"function"===typeof a.mso.xslx.formatId.numbers&&
(x=a.mso.xslx.formatId.numbers(d(q),k,l+A));0===x&&"function"===typeof a.mso.xslx.formatId.date&&(x=a.mso.xslx.formatId.date(d(q),k,l+A));if(49===x||"@"===x)B="s";else if("number"===D.type||0<x&&14>x||36<x&&41>x||48===x)B="n";else if("date"===D.type||13<x&&37>x||44<x&&48>x||56===x)B="d"}else B="s";if(null!=m)if(0===m.length)v.t=B||"z";else if(0!==m.trim().length&&"s"!==B)if("function"===D.type)v={f:m};else if("TRUE"===m)v={t:"b",v:!0};else if("FALSE"===m)v={t:"b",v:!1};else if(""===B&&d(q).find("a").length)m=
...
q:m,z:"string"===typeof x?x:x in w?w[x]:"m/d/yy"};c[na({c:n,r:h})]=v;g.e.c<n&&(g.e.c=n);n+=u}++h}f.length&&(c["!merges"]=f);t.length&&(c["!rows"]=t);g.e.r=h-1;c["!ref"]=oa(g);1E7<=h&&(c["!fullref"]=oa((g.e.r=e.length-k+h-1,g)));e="";"string"===typeof a.mso.worksheetName&&a.mso.worksheetName.length?e=a.mso.worksheetName+" "+(aa.length+1):"undefined"!==typeof a.mso.worksheetName[aa.length]&&(e=a.mso.worksheetName[aa.length]);e.length||(e=b.find("caption").text()||"");e.length||(e="Table "+(aa.length+
1));e=d.trim(e.replace(/[\\\/[\]*:?'"]/g,"").substring(0,31));aa.push(e);XLSX.utils.book_append_sheet(Fa,c,e)});h=XLSX.write(Fa,{type:"binary",bookType:a.mso.fileFormat,bookSST:!1});M(Oa(h),a.fileName+"."+a.mso.fileFormat,"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","UTF-8","",!1)}else if("excel"===a.type||"xls"===a.type||"word"===a.type||"doc"===a.type){h="excel"===a.type||"xls"===a.type?"excel":"word";q="excel"===h?"xls":"doc";l='xmlns:x="urn:schemas-microsoft-com:office:'+
h+'"';var H="",ba="";d(C).filter(function(){return I(d(this))}).each(function(){var b=d(this);""===ba&&(ba=a.mso.worksheetName||b.find("caption").text()||"Table",ba=d.trim(ba.replace(/[\\\/[\]*:?'"]/g,"").substring(0,31)));!1===a.exportHiddenCells&&(J=b.find("tr, th, td").filter(":hidden"),V=0<J.length);n=0;G=[];T=S(this);H+="<table><thead>";u=y(b);d(u).each(function(){var b=d(this);r="";B(this,"th,td",n,u.length,function(d,c,f){if(null!==d){var e="";r+="<th";if(a.mso.styles.length){var g=document.defaultView.getComputedStyle(d,
null),k=document.defaultView.getComputedStyle(b[0],null),h;for(h in a.mso.styles){var l=g[a.mso.styles[h]];""===l&&(l=k[a.mso.styles[h]]);""!==l&&"0px none rgb(0, 0, 0)"!==l&&"rgba(0, 0, 0, 0)"!==l&&(e+=""===e?'style="':";",e+=a.mso.styles[h]+":"+l)}}""!==e&&(r+=" "+e+'"');e=O(d);0<e&&(r+=' colspan="'+e+'"');e=U(d);0<e&&(r+=' rowspan="'+e+'"');r+=">"+E(d,c,f)+"</th>"}});0<r.length&&(H+="<tr>"+r+"</tr>");n++});H+="</thead><tbody>";w=v(b);d(w).each(function(){var b=d(this);r="";B(this,"td,th",n,u.length+
w.length,function(c,g,f){if(null!==c){var e=E(c,g,f),h="",k=d(c).attr("data-tableexport-msonumberformat");"undefined"===typeof k&&"function"===typeof a.mso.onMsoNumberFormat&&(k=a.mso.onMsoNumberFormat(c,g,f));"undefined"!==typeof k&&""!==k&&(h="style=\"mso-number-format:'"+k+"'");if(a.mso.styles.length){g=document.defaultView.getComputedStyle(c,null);f=document.defaultView.getComputedStyle(b[0],null);for(var l in a.mso.styles)k=g[a.mso.styles[l]],""===k&&(k=f[a.mso.styles[l]]),""!==k&&"0px none rgb(0, 0, 0)"!==
k&&"rgba(0, 0, 0, 0)"!==k&&(h+=""===h?'style="':";",h+=a.mso.styles[l]+":"+k)}r+="<td";""!==h&&(r+=" "+h+'"');h=O(c);0<h&&(r+=' colspan="'+h+'"');c=U(c);0<c&&(r+=' rowspan="'+c+'"');"string"===typeof e&&""!==e&&(e=Aa(e),e=e.replace(/\n/g,"<br>"));r+=">"+e+"</td>"}});0<r.length&&(H+="<tr>"+r+"</tr>");n++});a.displayTableName&&(H+="<tr><td></td></tr><tr><td></td></tr><tr><td>"+E(d("<p>"+a.tableName+"</p>"))+"</td></tr>");H+="</tbody></table>"});l='<html xmlns:o="urn:schemas-microsoft-com:office:office" '+
l+' xmlns="http://www.w3.org/TR/REC-html40">'+('<meta http-equiv="content-type" content="application/vnd.ms-'+h+'; charset=UTF-8">');l+="<head>";"excel"===h&&(l+="\x3c!--[if gte mso 9]>",l+="<xml>",l+="<x:ExcelWorkbook>",l+="<x:ExcelWorksheets>",l+="<x:ExcelWorksheet>",l+="<x:Name>",l+=ba,l+="</x:Name>",l+="<x:WorksheetOptions>",l+="<x:DisplayGridlines/>",a.mso.rtl&&(l+="<x:DisplayRightToLeft/>"),l+="</x:WorksheetOptions>",l+="</x:ExcelWorksheet>",l+="</x:ExcelWorksheets>",l+="</x:ExcelWorkbook>",
...
e,g)}return!1});g.headerrows=[];u=y(d(this));d(u).each(function(){b=0;g.headerrows[n]=[];B(this,"th,td",n,u.length,function(a,d,c){var e=Ba(a);e.title=E(a,d,c);e.key=b++;e.rowIndex=n;g.headerrows[n].push(e)});n++});if(0<n)for(var e=n-1;0<=e;)d.each(g.headerrows[e],function(){var a=this;0<e&&null===this.rect&&(a=g.headerrows[e-1][this.key]);null!==a&&0<=a.rowIndex&&(!0!==a.style.hasOwnProperty("hidden")||!0!==a.style.hidden)&&g.columns.push(a)}),e=0<g.columns.length?-1:e-1;var h=0;w=[];w=v(d(this));
d(w).each(function(){var a=[];b=0;B(this,"td,th",n,u.length+w.length,function(c,e,f){if("undefined"===typeof g.columns[b]){var k={title:"",key:b,style:{hidden:!0}};g.columns.push(k)}"undefined"!==typeof c&&null!==c?(k=Ba(c),k.isCanvas=c.hasAttribute("data-tableexport-canvas"),k.elements=k.isCanvas?d(c):d(c).children()):(k=d.extend(!0,{},g.teCells[h+":"+(b-1)]),k.colspan=-1);g.teCells[h+":"+b++]=k;a.push(E(c,e,f))});a.length&&(g.rows.push(a),h++);n++});if("function"===typeof g.onBeforeAutotable)g.onBeforeAutotable(d(this),
